 ...
 *
 */
public class XEjectedAndBannedYFromZHappeningSpecializer implements HappeningSpecializer<EjectedHappening> {

	private final Pattern pattern = Pattern.compile("@@(\\w+)@@ ejected and banned @@(\\w+)@@ from %%(\\w+)%%\\.");
