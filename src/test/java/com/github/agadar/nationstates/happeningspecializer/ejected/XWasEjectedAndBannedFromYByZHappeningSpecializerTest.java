...
public class XWasEjectedAndBannedFromYByZHappeningSpecializerTest {
	...
	public void isOfSpecializedType_true() {
		...
		// Arrange
		var specializer = new XWasEjectedAndBannedFromYByZHappeningSpecializer();
	...
	public void toSpecializedType() {
		...
		assertTrue(specialized.isBanned());
	}
}
